...
#include <FederatedLearning.h>  // Federated Learning library
#include <ARSDK.h>  // AR SDK for augmented reality
...
AWS_IOT awsClient;
VoiceRecognitionV3 vr(D2, D3);  // Voice recognition module
FederatedLearning fedLearning;  // Federated learning module
ARSDK arModule;  // Augmented reality module
...
void initPeripherals() {
  ...
  arModule.begin();  // Initialize augmented reality module
