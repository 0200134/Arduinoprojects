...
const char* cloud_endpoint = "YOUR_CLOUD_ENDPOINT"; // Example: AWS Lambda endpoint
const char* dynamodb_endpoint = "YOUR_DYNAMODB_ENDPOINT"; // DynamoDB endpoint
...
void log_to_dynamodb(String data) {
  if (WiFi.status() == WL_CONNECTED) {
    HTTPClient http;
    http.begin(dynamodb_endpoint);
    http.addHeader("Content-Type", "application/json");
