...
void loop() {
  ...
  mqttClient.loop();
  String payload = "temp=" + String(temperature) + "&hum=" + String(humidity) + "&press=" + String(pressure / 100.0F) + "&alt=" + String(altitude) + "&rain=" + String(rainValue) + "&light=" + String(lightValue) + "&soil=" + String(soilValue);
